#WEB library
from turtle import heading, left, title, width
...
st.set_page_config(page_title="Face Recognition", layout="wide", initial_sidebar_state="auto")
...
menu = ["HOME","LOGIN", "REGISTER", "DATA INFORMASI"] #menu
...
if choice == 'LOGIN': 
    st.markdown("<h2 style='text-align: center; color: black;'>Face Recognition</h2>", unsafe_allow_html=True) #title
    with col1: #column 1
        st.subheader("FACE RECOGNITION")
        run = st.checkbox("Jalakan Kamera") #checkbox
    if run == True:
        ...
        while True:
            ...
            for encodeFace,faceLoc in zip(encodeCurFrame,faceCurFrame):
                ...
                if matches[matchesIndex]:
                    ...
                    cv2.putText(img,"Tidak Dikenal !!",(x1+6,y2-6),cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),2)
...
#read data menu
    ...
    with col1:
        st.image("chloe.jpg",width=500) 
        st.title("#Implementasi OpenCV Face Recognition")
